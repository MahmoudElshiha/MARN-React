                            ...
                            <div className="flex-1 overflow-y-auto">
                                {conversations.map((conversation) => (
                                    <button
                                        ...
                                        className={`w-full p-4 flex gap-3 hover:bg-[#9CBBDC]/20 transition-colors border-b border-[#3A6EA5]/10 ${selectedConversation?.id === conversation.id
                                                ? 'bg-[#9CBBDC]/20'
                                                : ''
                                            }`}
                                    >
                                        ...
                                        {messages.map((message) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <p
                                                        className={`text-xs ${message.sender === 'me'
                                                                ? 'text-white/70'
                                                                : 'text-[#4a5565]'
                                                            }`}
                                                    >
