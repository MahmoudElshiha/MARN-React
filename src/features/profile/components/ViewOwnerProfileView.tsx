...
export function ViewOwnerProfileView() {
    ...
    if (error || !profile) {
        return (
            <div className="min-h-screen flex items-center justify-center text-red-500">
                {error?.message ?? 'Failed to load owner profile'}
            </div>
        )
    }
                        ...
                        <Card className="bg-[#E5EBF0] border-none rounded-3xl shadow-lg shadow-[#3A6EA5]/10">
                            <CardHeader>
                                <div className="flex items-center gap-3">
                                    ...
                                    <CardTitle className="text-2xl text-[#1a1a1a]">
                                        Properties ({profile.listings.length})
                                    </CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent>
                                <div className="grid md:grid-cols-2 gap-4">
                                    {profile.listings.map((property) => (
                                        <div
                                            key={property.id}
                ...
                <DialogContent className="bg-white rounded-3xl">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-[#6B7280]">
                            Please provide details about why you are reporting this owner.
                        </DialogDescription>
                    </DialogHeader>
