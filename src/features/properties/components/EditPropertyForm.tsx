...
const MAP_LOCATION = { lat: 30.0444, lng: 31.2357 }
...
const DEFAULT_FORM: PropertyFormData = {
  ...
  amenities: ['WiFi', 'Parking', 'Air Conditioning', 'Heating'],
}
            ...
            {currentStep === 1 && (
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl p-6">
                  ...
                  <div className="w-full h-64 bg-gradient-to-br from-[#9CBBDC]/30 to-[#f5f7fa] rounded-xl flex items-center justify-center">
                    <div className="text-center">
                      <MapPin className="w-12 h-12 mx-auto mb-3 text-[#3A6EA5]" />
                      <p className="text-sm text-[#4a5565]">
                        Lat: {MAP_LOCATION.lat.toFixed(4)}, Lng:{' '}
                        {MAP_LOCATION.lng.toFixed(4)}
                      </p>
                      <Button
                        className="mt-4 bg-white text-[#3A6EA5] hover:bg-[#f5f7fa] rounded-xl"
                        onClick={() =>
                          toast.info('Map selection — integration pending')
                        }
                      >
                        Select on Map
                      </Button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(v) => set('bedrooms', v)}
                    >
                      <SelectTrigger className="rounded-xl bg-white border-[#3A6EA5]/20">
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(v) => set('bathrooms', v)}
                    >
                      <SelectTrigger className="rounded-xl bg-white border-[#3A6EA5]/20">
                        <SelectValue />
                      </SelectTrigger>
                ...
                <div className="bg-white rounded-2xl p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(v) => set('numberOfPeople', v)}
                    >
                      <SelectTrigger
                        id="num-people"
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(v) => set('occupancyPreference', v)}
                    >
                      <SelectTrigger
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {(
                      [
                        ['dayRent', 'Day-based Rent', 'Per day'],
                        ['monthRent', 'Month-based Rent', 'Per month'],
                        ['yearRent', 'Year-based Rent', 'Per year'],
                      ] as [keyof PropertyFormData, string, string][]
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={preference} className="flex items-center">
                        <Checkbox
                          id={`edit-pref-${preference}`}
                          defaultChecked
                          className="border-[#3A6EA5] data-[state=checked]:bg-[#3A6EA5]"
                        />
                        <label
                          htmlFor={`edit-pref-${preference}`}
                          className="ml-3 text-[#1a1a1a] cursor-pointer"
                        >
                          {preference}
                        </label>
