...
export function ConfirmEmailPage() {
  ...
  const [message, setMessage] = useState(
    !userId || !tokenParam ? t('confirmEmail.invalidLink') : '',
  )
      ...
      >
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-sm text-[#6a7282] mb-6">{t('confirmEmail.redirecting')}</p>
            <Button
        ...
        {status === 'error' && (
          <>
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link to="/signup" className="text-sm text-[#3A6EA5] hover:underline">
