...
function ImportanceRating({
  ...
  return (
    <div className="flex items-center gap-1.5 mt-2.5">
      <span className="text-xs text-[#4a5565] shrink-0 mr-1">{label}</span>
      {[1, 2, 3, 4, 5].map((n) => (
        <button
          key={n}
          type="button"
...
export function RoommateTab() {
  ...
  const importanceLabel = t('roommateTab.fields.importance')
      ...
      <CardContent className="space-y-8">
        ...
        <div>
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-lg font-semibold text-[#1a1a1a]">
              {t('roommateTab.sections.education')}
            </h3>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <Label className="text-[#1a1a1a]">
                  {t('roommateTab.fields.noiseTolerance')}
                </Label>
        ...
        <div className="flex gap-4 justify-end pt-4">
          ...
          <Button
            ...
            onClick={handleSave}
          >
            {updateRoommate.isPending ? '…' : t('roommateTab.savePreferences')}
          </Button>
        </div>
      </CardContent>
    </Card>
