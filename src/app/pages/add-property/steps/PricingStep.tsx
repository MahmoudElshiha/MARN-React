    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <Label htmlFor="price" className="text-[#1a1a1a] mb-2 block">
            ...
            <div className="relative">
              ...
              <Input
                id="price"
                type="number"
                placeholder={t('addProperty.pricingStep.pricePlaceholder')}
        ...
        <div className="grid grid-cols-2 gap-3">
          {utilities.map((utility) => (
            <div key={utility} className="flex items-center">
              ...
              />
              <label htmlFor={utility} className="ml-3 text-[#1a1a1a] cursor-pointer">
