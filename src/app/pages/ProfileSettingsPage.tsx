...
import { User, Mail, Phone, Globe, Lock, Bell, Shield, Camera, Users, Home, Briefcase, Moon, Volume2, Coffee, GraduationCap, UserPlus, Upload, FileText, IdCard } from 'lucide-react';
...
export function ProfileSettingsPage() {
  ...
  const countries = [
    ...
    'Finland', 'Switzerland', 'Austria', 'Ireland', 'New Zealand', 'Japan', 'Singapore',
  ...
  const handleFileUpload = (field: 'frontIdCard' | 'backIdCard', e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    <div className="min-h-screen py-20">
        ...
        >
          ...
          <Tabs defaultValue="profile" className="space-y-8">
            <TabsList className="bg-[#F2F4F6] p-2 rounded-2xl">
              <TabsTrigger value="profile" className="rounded-xl data-[state=active]:bg-white data-[state=active]:text-[#3A6EA5]">
                Profile
              </TabsTrigger>
              <TabsTrigger value="security" className="rounded-xl data-[state=active]:bg-white data-[state=active]:text-[#3A6EA5]">
                Security
              </TabsTrigger>
              <TabsTrigger value="documents" className="rounded-xl data-[state=active]:bg-white data-[state=active]:text-[#3A6EA5]">
                Documents
              </TabsTrigger>
              <TabsTrigger value="roommate" className="rounded-xl data-[state=active]:bg-white data-[state=active]:text-[#3A6EA5]">
                Roommate Settings
              </TabsTrigger>
            </TabsList>
                ...
                <Card className="bg-[#F2F4F6] border-none rounded-3xl shadow-lg shadow-[#3A6EA5]/10 lg:col-span-2">
                  ...
                  <CardContent className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      {/* Date of Birth */}
                      <div>
                        <Label htmlFor="dateOfBirth" className="text-[#1a1a1a] mb-2 block">
                          Date of Birth
                        </Label>
                        <Input
                          id="dateOfBirth"
                      ...
                      {/* Country Dropdown */}
                      <div>
                        <Label htmlFor="country" className="text-[#1a1a1a] mb-2 block">
                          Country
                        </Label>
                        <Select
                        ...
                        >
                          <SelectTrigger id="country" className="bg-white rounded-xl border-[#3A6EA5]/20">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setIdentityVerification({ ...identityVerification, nameArabic: e.target.value })}
                        className="bg-white rounded-xl border-[#3A6EA5]/20"
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setIdentityVerification({ ...identityVerification, addressArabic: e.target.value })}
                        className="bg-white rounded-xl border-[#3A6EA5]/20"
                    ...
                    <div className="md:col-span-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setIdentityVerification({ ...identityVerification, nationalIdNumber: e.target.value })}
                        className="bg-white rounded-xl border-[#3A6EA5]/20"
              ...
              <Card className="bg-[#F2F4F6] border-none rounded-3xl shadow-lg shadow-[#3A6EA5]/10">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-2xl text-[#1a1a1a]">Roommate Preferences & Lifestyle</CardTitle>
                      <p className="text-sm text-[#4a5565] mt-1">
                ...
                <CardContent className="space-y-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="flex items-center justify-between p-6 bg-white rounded-2xl">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) => {
                              setRoommateSettings({ ...roommateSettings, smoking: checked });
                      ...
                      <div>
                        ...
                        <div className="flex items-center justify-between p-6 bg-white rounded-2xl">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) => {
                              setRoommateSettings({ ...roommateSettings, pets: checked });
                              setHasUnsavedChanges(true);
                            }}
                            className="data-[state=checked]:bg-[#3A6EA5]"
                          />
                      ...
                      {roommateSettings.pets && (
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              setRoommateSettings({ ...roommateSettings, petType: e.target.value });
                              setHasUnsavedChanges(true);
                            }}
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) => {
                            setRoommateSettings({ ...roommateSettings, sleepSchedule: value });
                            setHasUnsavedChanges(true);
                          }}
                        >
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) => {
                            setRoommateSettings({ ...roommateSettings, educationLevel: value });
                            setHasUnsavedChanges(true);
                          }}
                        >
                      ...
                      <div>
                        <Label htmlFor="field-of-study" className="text-[#1a1a1a] mb-2 block">
                          Field of Study <span className="text-[#4a5565] text-sm font-normal">(Optional)</span>
                        </Label>
                        <Select
                          value={roommateSettings.fieldOfStudy}
                          onValueChange={(value) => {
                            setRoommateSettings({ ...roommateSettings, fieldOfStudy: value });
                            setHasUnsavedChanges(true);
                          }}
                        >
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="flex items-center gap-2 text-sm text-[#4a5565]">
                            ...
                            <span>
                              ...
                              {roommateSettings.noiseTolerance[0] > 33 && roommateSettings.noiseTolerance[0] <= 66 && 'Medium'}
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => {
                            setRoommateSettings({ ...roommateSettings, noiseTolerance: value });
                            setHasUnsavedChanges(true);
                          }}
                          max={100}
                          step={1}
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) => {
                              setRoommateSettings({ ...roommateSettings, guestsFrequency: value });
                              setHasUnsavedChanges(true);
                            }}
                          >
                            <SelectTrigger id="guests-frequency" className="bg-white rounded-xl border-[#3A6EA5]/20">
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) => {
                              setRoommateSettings({ ...roommateSettings, workSchedule: value });
                              setHasUnsavedChanges(true);
                            }}
                          >
                            <SelectTrigger id="work-schedule" className="bg-white rounded-xl border-[#3A6EA5]/20">
                      ...
                      <div>
                        ...
                        <ToggleGroup
                          ...
                          onValueChange={(value) => {
                            if (value) {
                              setRoommateSettings({ ...roommateSettings, sharingLevel: value });
                              setHasUnsavedChanges(true);
                            }
                          }}
                  ...
                  <div>
                    ...
                    <div>
                      <Label htmlFor="roommate-bio" className="text-[#1a1a1a] mb-2 block">
                        Bio
                      </Label>
                      <Textarea
                        id="roommate-bio"
                        ...
                        onChange={(e) => {
                          if (e.target.value.length <= bioMaxLength) {
                            setRoommateSettings({ ...roommateSettings, bio: e.target.value });
                            setHasUnsavedChanges(true);
                          }
                        }}
                        className="bg-white rounded-xl border-[#3A6EA5]/20 min-h-[120px]"
                    ...
                    <div className="bg-white rounded-2xl p-6">
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) => {
                            setRoommateSettings({ ...roommateSettings, profileVisible: checked });
                            setHasUnsavedChanges(true);
                          }}
                          className="data-[state=checked]:bg-[#3A6EA5]"
                        />
                      ...
                      {!roommateSettings.profileVisible && (
                        <div className="mt-4 p-4 bg-[#F2F4F6] rounded-xl flex items-start gap-3">
                          ...
                          <p className="text-sm text-[#1a1a1a]">
                            Your roommate preferences are stored but hidden from other users. Enable visibility to help potential roommates find you.
                          </p>
                        </div>
                      )}
                    </div>
      ...
      <Dialog open={show2FAModal} onOpenChange={setShow2FAModal}>
        <DialogContent className="bg-white rounded-3xl">
          <DialogHeader>
            <DialogTitle className="text-2xl text-[#1a1a1a]">Enable Two-Factor Authentication</DialogTitle>
