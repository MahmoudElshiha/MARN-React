    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6">
        <Label className="text-[#1a1a1a] mb-3 block">
          {t('editProperty.availabilityStep.leaseDuration')}
        </Label>
        <RadioGroup
        ...
        >
          {[
            { label: t('editProperty.availabilityStep.daily'), value: 'Daily' },
            { label: t('editProperty.availabilityStep.monthly'), value: 'Monthly' },
            { label: t('editProperty.availabilityStep.yearly'), value: 'Yearly' },
          ].map((option) => (
      ...
      <div className="bg-white rounded-2xl p-6">
        <Label className="text-[#1a1a1a] mb-3 block">
          {t('editProperty.availabilityStep.tenantPreferences')}
        </Label>
        ...
        <div className="flex gap-2 mb-4">
          <Input
            ...
            placeholder={t('editProperty.availabilityStep.enterPreferencePlaceholder')}
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={preference} className="flex items-center">
              ...
              >
                {t(`editProperty.availabilityStep.preferences.${preference}`, { defaultValue: preference })}
              </label>
            </div>
          ))}
        ...
        <p className="text-xs text-[#4a5565] mt-4">
          {t('editProperty.availabilityStep.addPreferenceTip')}
        </p>
      </div>
